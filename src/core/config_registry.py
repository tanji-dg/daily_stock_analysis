...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "REPORT_LANGUAGE": {
        ...
        "description": "Default output language for reports and notification templates. Supported values: zh, en, ja.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "MARKET_REVIEW_REGION": {
        ...
        "description": "Market region for review: cn (A-shares), hk (Hong Kong), us (US stocks), jp (Japan), or both (cn/hk/us markets).",
        "category": "system",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "validation": {"enum": ["cn", "hk", "us", "jp", "both"]},
        "display_order": 48,
        "help_key": "settings.system.market_review",
        "examples": [
            "MARKET_REVIEW_REGION=cn",
